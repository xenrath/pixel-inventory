                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="nama_bank" name="nama_bank">
                                ...
                                <option value="BRI"
                                    {{ old('nama_bank', $supplier->nama_bank) == 'BRI' ? 'selected' : null }}>
                                    BRI</option>
                                <option value="MANDIRI"
                                    {{ old('nama_bank', $supplier->nama_bank) == 'MANDIRI' ? 'selected' : null }}>
                                    MANDIRI</option>
                                <option value="BNI"
                                    {{ old('nama_bank', $supplier->nama_bank) == 'BNI' ? 'selected' : null }}>
                                    BNI</option>
                                <option value="BTN"
                                    {{ old('nama_bank', $supplier->nama_bank) == 'BTN' ? 'selected' : null }}>
                                    BTN</option>
                                <option value="DANAMON"
                                    {{ old('nama_bank', $supplier->nama_bank) == 'DANAMON' ? 'selected' : null }}>
                                    DANAMON</option>
                                <option value="BCA"
                                    {{ old('nama_bank', $supplier->nama_bank) == 'BCA' ? 'selected' : null }}>
                                    BCA</option>
                                <option value="PERMATA"
                                    {{ old('nama_bank', $supplier->nama_bank) == 'PERMATA' ? 'selected' : null }}>
                                    PERMATA</option>
                                <option value="PAN"
                                    {{ old('nama_bank', $supplier->nama_bank) == 'PAN' ? 'selected' : null }}>
                                    PAN</option>
                                <option value="CIMB NIAGA"
                                    {{ old('nama_bank', $supplier->nama_bank) == 'CIMB NIAGA' ? 'selected' : null }}>
                                    CIMB NIAGA</option>
                                <option value="UOB"
                                    {{ old('nama_bank', $supplier->nama_bank) == 'UOB' ? 'selected' : null }}>
                                    UOB</option>
                                <option value="ARTHA GRAHA"
                                    {{ old('nama_bank', $supplier->nama_bank) == 'ARTHA GRAHA' ? 'selected' : null }}>
                                    ARTHA GRAHA</option>
                                <option value="BUMI ARTHA"
                                    {{ old('nama_bank', $supplier->nama_bank) == 'BUMI ARTHA' ? 'selected' : null }}>
                                    BUMI ARTHA</option>
                                <option value="MEGA"
                                    {{ old('nama_bank', $supplier->nama_bank) == 'MEGA' ? 'selected' : null }}>
                                    MEGA</option>
                                <option value="SYARIAH"
                                    {{ old('nama_bank', $supplier->nama_bank) == 'SYARIAH' ? 'selected' : null }}>
                                    SYARIAH</option>
                                <option value="MEGA SYARIAH"
                                    {{ old('nama_bank', $supplier->nama_bank) == 'MEGA SYARIAH' ? 'selected' : null }}>
                                    MEGA SYARIAH</option>
                            </select>
                        </div>
                        <div class="form-group">
