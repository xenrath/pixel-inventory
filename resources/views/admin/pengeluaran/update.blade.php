...
@section('title', 'Perbarui Pengeluaran')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Perbarui Pengeluaran</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/pengeluaran') }}">Perbarui Pengeluaran</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/pengeluaran/' . $pengeluaran->id) }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                @method('put')
                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group" hidden>
                                            ...
                                            <input type="text" class="form-control" id="supplier_id" readonly
                                                ...
                                                value="{{ old('supplier_id', $pengeluaran->supplier_id) }}">
                                        </div>
                                        ...
                                        <div class="form-group d-flex">
                                            <input class="form-control" id="nama_supp" name="nama_supp" type="text"
                                                placeholder="" value="{{ old('nama_supp', $pengeluaran->nama_supp) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size:14px" type="text" class="form-control" id="telp"
                                                ...
                                                value="{{ old('telp', $pengeluaran->telp) }}">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input style="font-size:14px" type="text" class="form-control" id="alamat"
                                                ...
                                                value="{{ old('alamat', $pengeluaran->alamat) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group" hidden>
                                            ...
                                            <input type="text" class="form-control" id="user_id" readonly
                                                ...
                                                value="{{ old('user_id', $pengeluaran->user_id) }}">
                                        </div>
                                        <label style="font-size:14px" class="form-label" for="nama_driver">Nama
                                            Sales</label>
                                        <div class="form-group d-flex">
                                            <input class="form-control" id="nama" name="nama" type="text"
                                                placeholder="" value="{{ old('nama', $pengeluaran->nama) }}" readonly
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size:14px" type="tex" class="form-control"
                                                ...
                                                value="{{ old('telp_sales', $pengeluaran->telp_sales) }}">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input style="font-size:14px" type="text" class="form-control"
                                                ...
                                                value="{{ old('alamat_sales', $pengeluaran->alamat_sales) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                            ...
                                            <tr id="barang-{{ $loop->index }}">
                                                ...
                                                <td style="width: 100px">
                                                    ...
                                                    <button style="margin-left:5px" type="button"
                                                        ...
                                                        onclick="removeBarang({{ $loop->index }}, {{ $detail['id'] }})">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <input style="text-align: end; margin:right:10px; font-size:14px;" type="text"
                                        ...
                                        placeholder="" value="{{ old('grand_total', $pengeluaran->grand_total) }}">
                                </div>
                            </div>
    ...
    <script>
        ...
        function removeBarang(identifier, detailId) {
            var row = document.getElementById('barang-' + identifier);
            row.remove();

            $.ajax({
                url: "{{ url('admin/pengeluaran/delete_barang/') }}/" + detailId,
                type: "POST",
                data: {
                    _method: 'DELETE',
                    _token: '{{ csrf_token() }}'
