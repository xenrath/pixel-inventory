...
@section('content')
                ...
                <div class="card-body">
                    <form method="GET" id="form-action">
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-3">
                                <a href="{{ url('admin/pengeluaran/create') }}" type="button"
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach ($pengeluarans as $pengeluaran)
                            ...
                            <div class="modal fade" id="modal-hapus-{{ $pengeluaran->id }}">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Yakin hapus pengeluaran <strong>{{ $pengeluaran->nama }}</strong>?</p>
                                        </div>
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/pengeluaran') }}";
            form.submit();
        }
    </script>
@endsection
