...
@section('content')
    ...
    <script>
        ...
        function set_item(urutan, data, is_session = false) {
            ...
            col += '<option value="' + data.harga_pcs + '" ' + check_pcs + '>' + rupiah(data.harga_pcs ?? "0", "Rp") + ' (pcs)</option>';
            col += '<option value="' + data.harga_dus + '" ' + check_dus + '>' + rupiah(data.harga_dus ?? "0", "Rp") + ' (dus)</option>';
            col += '<option value="' + data.harga_renceng + '" ' + check_renceng + '>' + rupiah(data.harga_renceng ?? "0", "Rp") + ' (renceng)</option>';
            col += '<option value="' + data.harga_pack + '" ' + check_pack + '>' + rupiah(data.harga_pack ?? "0", "Rp") + ' (pack)</option>';
            col += '</select>';
            col += '</div>';
            col += '</td>';
            col += '<td>';
