    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <form action="{{ url('sales/profile/update') }}" method="post" enctype="multipart/form-data"
                    autocomplete="off">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama_lengkap"
                                placeholder="Masukan nama user" value="{{ old('nama', $user->nama) }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="alamat" name="alamat" rows="3" placeholder="Masukan alamat">{{ old('alamat', $user->alamat) }}</textarea>
                        </div>
                        {{-- <div class="form-group">
