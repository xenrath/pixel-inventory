            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <a href="{{ url('sales/barang/create') }}" class="btn btn-primary btn-sm">
                            ...
                            @foreach ($barangs as $barang)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        {{-- <a href="{{ url('sales/barang/' . $barang->id) }}" class="btn btn-info btn-sm">
                                            <i class="fas fa-eye"></i>
                                        </a> --}}
                                        <a href="{{ url('sales/barang/' . $barang->id . '/edit') }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer justify-content-between">
                                                ...
                                                <form action="{{ url('sales/barang/' . $barang->id) }}" method="POST">
                                                    @csrf
                                                    @method('delete')
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div style="text-align: center;">
                                                    <form action="{{ url('sales/stok/' . $barang->id) }}" method="POST"
