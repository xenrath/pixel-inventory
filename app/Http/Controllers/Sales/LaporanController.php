...
class LaporanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('sales.laporan.index', compact('laporans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('sales/laporan')->with('success', 'Berhasil menambahkan laporan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('sales/laporan')->with('success', 'Berhasil memperbarui laporan');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('sales/laporan')->with('success', 'Berhasil menghapus laporan');
    }
}