...
class PemasukanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('sales.pemasukan.index', compact('pemasukans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('sales/pemasukan')->with('success', 'Berhasil menambah pemasukan');
    }
    ...
    public function cetakpdf($id)
    {
        ...
        $pdf = PDF::loadView('sales.pemasukan.cetak_pdf', compact('details', 'pemasukan'));
