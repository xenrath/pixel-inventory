...
class BarangController extends Controller
{
    ...
    {
        return view('sales.barang.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('sales/barang')->with('success', 'Berhasil menambahkan barang');
    }
    ...
    public function edit($id)
    {
        ...
        return view('sales.barang.edit', compact('barang'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('sales/barang')->with('success', 'Berhasil mengubah barang');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('sales/barang')->with('success', 'Berhasil menghapus barang');
    }
}